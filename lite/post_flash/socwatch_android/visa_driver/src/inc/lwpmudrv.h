...
struct DISPATCH_NODE_S {
    ...
    VOID (*create_lakemore_mem)(U32, U64*);
    VOID (*check_lakemore_status)(U64*, U32*);
    VOID (*read_lakemore_mem)(U64, U64*, U32);
    VOID (*stop_lakemore)(VOID);
};
...
extern LWPMU_DEVICE   device_visa;
